...
hi comment      guibg=#000000   guifg=#339900   gui=none

hi constant     guibg=#000000   guifg=#dd3333   gui=none
hi specialchar  guibg=#000000   guifg=#ff3333   gui=underline

hi identifier   guibg=#000000   guifg=#3333ff   gui=none

hi statement    guibg=#000000   guifg=#3333ff   gui=none
hi label        guibg=#000000   guifg=#3333ff   gui=none

hi preproc      guibg=#000000   guifg=#3333ff   gui=none
hi include      guibg=#000000   guifg=#3333ff   gui=none
hi precondit    guibg=#000000   guifg=#cc00cc   gui=none

hi type         guibg=#000000   guifg=#3333ff   gui=none

hi special      guibg=#000000   guifg=#cc00cc   gui=none

hi error        guibg=#dd3333   guifg=#ffffff   gui=none
...
hi errormsg     guibg=#dd3333   guifg=#ffffff   gui=none
...
hi statuslinenc guibg=#ffffff   guifg=#999999   gui=none
